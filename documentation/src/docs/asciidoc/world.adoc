...
[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/world/domain/WorldImpl.java[tags=averageCityPopulation]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/world/domain/api/World.java[tags=locationValidator]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/world/domain/api/World.java[tags=noOfSpeakers]
----
